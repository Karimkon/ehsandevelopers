<x-layouts.admin>
    <x-slot:title>New Blog Post</x-slot:title>
    ...
    <div class="max-w-4xl">
        <form action="{{ route('admin.blog.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="admin-card p-6 space-y-6">
                ...
                <!-- Slug -->
                <div>
                    <label for="slug" class="block text-sm font-medium text-gray-300 mb-1">Slug <span class="text-gray-500">(auto-generated if empty)</span></label>
                ...
                <div>
                    ...
                    <textarea name="excerpt" id="excerpt" rows="2"
                              class="admin-input w-full" placeholder="Short summary for blog listing...">{{ old('excerpt') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="content" id="content" rows="15" required
                              class="admin-input w-full font-mono text-sm" placeholder="Write your blog post content here... (HTML supported)">{{ old('content') }}</textarea>
                    <p class="mt-1 text-xs text-gray-500">HTML is supported. Use headings (h2, h3), paragraphs, lists, and links for better SEO.</p>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="meta_title" id="meta_title" value="{{ old('meta_title') }}"
                                   class="admin-input w-full" placeholder="SEO title (defaults to post title)">
                        ...
                        <div>
                            ...
                            <textarea name="meta_description" id="meta_description" rows="2"
                                      class="admin-input w-full" placeholder="SEO description for search engines...">{{ old('meta_description') }}</textarea>
