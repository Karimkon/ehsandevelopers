<x-layouts.admin>
    <x-slot:title>New Portfolio Project</x-slot:title>
    <x-slot:header>New Portfolio Project</x-slot:header>
            ...
            <div class="admin-card p-6 space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="5"
                              class="admin-input w-full" placeholder="Describe the project...">{{ old('description') }}</textarea>
