<x-layouts.admin>
    ...
    <x-slot:header>Edit Service</x-slot:header>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="admin-card space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name', $service->name) }}" class="admin-input" required placeholder="Service name">
                        @error('name')
                            <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="slug" id="slug" value="{{ old('slug', $service->slug) }}" class="admin-input" placeholder="auto-generated-from-name">
                    ...
                    <div>
                        ...
                        <textarea name="short_description" id="short_description" rows="2" maxlength="500" class="admin-input" placeholder="Brief summary of the service (max 500 characters)">{{ old('short_description', $service->short_description) }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="5" class="admin-input" placeholder="Full description of the service">{{ old('description', $service->description) }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <!-- Features -->
                <div class="admin-card" x-data="{ features: @js(old('features', $service->features ?? [''])) }">
            ...
            <div class="space-y-6">
                ...
                <div class="admin-card space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="icon" id="icon" value="{{ old('icon', $service->icon) }}" class="admin-input" placeholder="e.g. heroicon-o-code-bracket">
                    ...
                    <div>
                        ...
                        <input type="number" name="sort_order" id="sort_order" value="{{ old('sort_order', $service->sort_order) }}" class="admin-input" min="0">
                        @error('sort_order')
                            <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        <label class="flex items-center gap-3 cursor-pointer">
                            ...
                            <input type="checkbox" name="is_active" value="1" {{ old('is_active', $service->is_active) ? 'checked' : '' }} class="w-4 h-4 rounded border-surface-600 bg-surface-800 text-primary-600 focus:ring-primary-600 focus:ring-offset-0">
