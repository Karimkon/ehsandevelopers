<x-layouts.admin>
    <x-slot:title>Add Trusted Client</x-slot:title>
    <x-slot:header>Add Trusted Client</x-slot:header>

    <div class="max-w-2xl">
        <form action="{{ route('admin.trusted-clients.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="admin-card p-6 space-y-6">
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs text-gray-500">Recommended: Square PNG with transparent background, max 1MB</p>
            ...
            <div class="flex items-center gap-3 mt-6">
                <button type="submit" class="admin-btn">Save Client</button>
